...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'football_user', 'nom')

        # Deleting field 'User.prenom'
        db.delete_column(u'football_user', 'prenom')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'User.nom'
        raise RuntimeError("Cannot reverse this migration. 'User.nom' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'User.nom'
        db.add_column(u'football_user', 'nom',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'User.prenom'
        raise RuntimeError("Cannot reverse this migration. 'User.prenom' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'User.prenom'
        db.add_column(u'football_user', 'prenom',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)
